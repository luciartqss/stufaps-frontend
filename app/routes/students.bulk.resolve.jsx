...
const FIELD_LABELS = {
  ...
  sex: 'Sex', civil_status: 'Civil Status', date_of_birth: 'Date of Birth', contact_number: 'Contact Number',
  email_address: 'Email Address', street: 'Street', brgy_psgc_code: 'Brgy PSGC Code', brgy: 'Barangay',
  municipality_psgc_code: 'Municipality PSGC Code', municipality: 'Municipality',
  province_psgc_code: 'Province PSGC Code', province: 'Province',
  congressional_district: 'Congressional District', zip_code: 'Zip Code',
  ...
  program_discipline: 'Program Discipline', discipline_code: 'Discipline Code',
  program_degree_level: 'Program Degree Level',
  authority_type: 'Authority Type', authority_number: 'Authority Number', series: 'Series',
  prio_program_code: 'Priority Program Code', is_priority: 'Priority', basis_cmo: 'Basis (CMO)', scholarship_status: 'Scholarship Status',
