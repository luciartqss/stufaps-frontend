...
export function meta() {
    return [
        { title: 'Scholarship for Children and Dependents of Sugarcane Industry Workers and Small Sugarcane Farmers (SIDA-SGP) | StuFAPs' },
...
export default function FinancialAssistanceSida_Sgp() {
    ...
    const filteredSida_Sgp = (() => {
        const allData = (Array.isArray(financialAssistances) ? financialAssistances : [])
            .filter(p => p?.scholarship_program_name?.toUpperCase() === 'SIDASGP')
    ...
    return (
        <div style={{ background: '#fff', margin: -24, minHeight: 'calc(100vh - 72px)' }}>
            ...
            <div style={{ padding: '24px', borderBottom: '1px solid #e8eaed' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <div>
                        ...
                        <Text style={{ color: '#6b7280', fontSize: 16 }}>Scholarship for Children and Dependents of Sugarcane Industry Workers and Small Sugarcane Farmers</Text>
                    </div>
                    <Space size={12}>
            ...
            <div style={{ padding: '24px', borderBottom: '1px solid #e8eaed' }}>
                <StatsCards financialAssistances={filteredSida_Sgp} semester={semesterFilter} />
            </div>
