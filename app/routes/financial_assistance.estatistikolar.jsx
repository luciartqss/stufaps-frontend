...
export default function FinancialAssistanceEstatistikolar() {
  ...
  return (
    <div style={{ background: '#fff', margin: -24, minHeight: 'calc(100vh - 72px)' }}>
      ...
      <div style={{ padding: '12px 24px 24px', borderBottom: '1px solid #e8eaed' }}>
        <Space size={12} align="start">
          <StopOutlined style={{ fontSize: 24, color: '#6b7280', marginTop: 6 }} />
          <Title level={2} style={{ margin: 0, color: '#1a1a1a', fontWeight: 600 }}>
      ...
      <div style={{ padding: '12px 24px 24px', borderBottom: '1px solid #e8eaed' }}>
        <Space size={12} align="start">
          <FileAddOutlined style={{ fontSize: 24, color: '#6b7280', marginTop: 6 }} />
          <Title level={2} style={{ margin: 0, color: '#1a1a1a', fontWeight: 600 }}>
      ...
      <div style={{ padding: '12px 24px 24px', borderBottom: '1px solid #e8eaed' }}>
        <Space size={12} align="start">
          <ProfileOutlined style={{ fontSize: 24, color: '#6b7280', marginTop: 6 }} />
          <Title level={2} style={{ margin: 0, color: '#1a1a1a', fontWeight: 600 }}>
            Transferee/Shiftee
          </Title>
        </Space>
      ...
      <div style={{ padding: '12px 24px 24px', borderBottom: '1px solid #e8eaed' }}>
        <Space size={12} align="start">
          <InteractionOutlined style={{ fontSize: 24, color: '#6b7280', marginTop: 6 }} />
          <Title level={2} style={{ margin: 0, color: '#1a1a1a', fontWeight: 600 }}>
            Refund
          </Title>
        </Space>
