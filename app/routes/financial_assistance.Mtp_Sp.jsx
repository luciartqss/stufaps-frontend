...
export function meta() {
  return [
    { title: 'Medical Technologist and Pharmacists Scholarship (MTP-SP) | StuFAPs' },
...
export default function FinancialAssistanceMTP() {
  ...
  const filteredMTP_SP = (() => {
    const allData = (Array.isArray(financialAssistances) ? financialAssistances : [])
      .filter(p => p?.scholarship_program_name?.toUpperCase() === 'MTPSP')
  ...
  return (
    <div style={{ background: '#fff', margin: -24, minHeight: 'calc(100vh - 72px)' }}>
      ...
      <div style={{ padding: '24px', borderBottom: '1px solid #e8eaed' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            ...
            <Text style={{ color: '#6b7280', fontSize: 16 }}>Medical Technologist and Pharmacists Scholarship</Text>
          </div>
          <Space size={12}>
      ...
      <div style={{ padding: '24px', borderBottom: '1px solid #e8eaed' }}>
        <StatsCards financialAssistances={filteredMTP_SP} semester={semesterFilter} />
      </div>
