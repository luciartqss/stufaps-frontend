        ...
        <div style={{ paddingRight: '24px', paddingTop: '12px', paddingLeft: '24px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <Text style={{ color: '#6b7280', fontSize: 16 }}>
              The Scholarship Program for Future Medical Technologists and Pharmacists is an initiative by the
              Commission on Higher Education (CHED) aimed at strengthening the healthcare workforce in the Philippines.
            </Text>
          </div>
        </div>
      </div>
            ...
            <div>
              ...
              <Typography style={{ color: '#6b7280', fontSize: 16 }}>
                <ol className="list-decimal">
                  ...
                  <li>
                    <strong>The CHEDRO shall:</strong> <br /><br />
                    <ol type="a" className="list-[lower-alpha]">
      ...
      <div style={{ background: '#fff' }}>
        <div style={{ paddingRight: '24px', paddingTop: '12px', paddingLeft: '24px' }}>
          <div style={{ paddingBottom: '24px', borderBottom: '1px solid #e8eaed' }}>
            ...
            <div>
              <Space size={12}>
                <MedicineBoxOutlined style={{ paddingBottom: '10px', fontSize: 24, color: '#6b7280' }} />
                <Title level={2} style={{ color: '#1a1a1a', fontWeight: 600 }}>
                  Medical Tuition Package (MTP)
                </Title>
              </Space>
              <br />
                    ...
                    >
                      ...
                      <table style={{ width: '100%' }}>
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td style={{ border: '1px solid #000', padding: '8px' }}>Stipend (subsistence, clothing, transportation allowance, educational tours, field trips, <br /> expenses for small projects, and medical insurance)</td>
                        ...
                        <tfoot style={{ background: '#CED4DA' }}>
                          <tr>
                            ...
                            <td style={{ border: '1px solid #000', padding: '8px', fontWeight: 'bold', textAlign: 'center' }}>₱105,000.00</td>
                            <td style={{ border: '1px solid #000', padding: '8px', fontWeight: 'bold', textAlign: 'center' }}>₱210,000.00</td>
                          </tr>
                        </tfoot>
      ...
      <div style={{ background: '#fff' }}>
        <div style={{ paddingRight: '24px', paddingTop: '12px', paddingLeft: '24px' }}>
          <div style={{ paddingBottom: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #e8eaed' }}>
            <div>
              <Space size={12}>
                <CreditCardOutlined style={{ paddingBottom: '10px', fontSize: 24, color: '#6b7280' }} />
                <Title level={2} style={{ paddingBottom: '1px', color: '#1a1a1a', fontWeight: 600 }}>
              ...
              <Typography style={{ color: '#6b7280', fontSize: 16 }}>
                <ol className="list-decimal">
                  ...
                  <li>
                    <strong>Must be supported by the Registrar's Certificate (Annex "H"), which specifies:</strong>
                    <br /><br />
                    <ol type="a" className="list-[lower-alpha]">
          ...
          <div style={{ paddingBottom: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #e8eaed' }}>
            <div>
              <Space size={12}>
                ...
                <Title level={2} style={{ paddingBottom: '1px', color: '#1a1a1a', fontWeight: 600 }}>
                  Transfer of a Scholar to Other identified participating SUCs or PHEIs
                </Title>
              </Space>
              <br />
      ...
      <div style={{ background: '#fff' }}>
        <div style={{ paddingRight: '24px', paddingTop: '12px', paddingLeft: '24px' }}>
          <div style={{ paddingBottom: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #e8eaed' }}>
            <div>
              <Space size={12}>
                <RetweetOutlined style={{ paddingBottom: '10px', fontSize: 24, color: '#6b7280' }} />
                <Title level={2} style={{ paddingBottom: '1px', color: '#1a1a1a', fontWeight: 600 }}>
